...
@onready var planets = {
	...
	"Ice World3D": preload("res://Planets/IceWorld/IceWorld.tscn"),
	"Lava World3D": preload("res://Planets/LavaWorld/LavaWorld.tscn"),
...
func _on_LineEdit_text_changed(new_text: String):
	call_deferred("_make_from_seed", new_text.to_int())
...
func _make_color_buttons():
	...
	for i in colors.size():
		...
		b.connect("button_pressed",Callable(self,"_on_colorbutton_pressed"))
...
func _on_InputPixels_text_changed(text: String):
	pixels = text.to_int()
